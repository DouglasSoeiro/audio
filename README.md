...
O player combina movimento de câmera na ilustração, partículas de luz e barras animadas de reprodução (ilustrativas, não um analisador de frequência). A animação pausa com o áudio e respeita prefers-reduced-motion.
